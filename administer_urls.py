...
tasks_list = login_required(TaskIndexView.as_view(module_name='administer',
                            ...
                            login_url=reverse_lazy('login'))
tasks_all = login_required(TaskIndexView.as_view(module_name='administer',
                                                 queryset=Task.get_all_tasks(0),
                                                 action_label='all'),
                           login_url=reverse_lazy('login'))
tasks_draft = login_required(TaskIndexView.as_view(module_name='administer',
                                                   queryset=Task.get_draft_tasks(0),
                                                   action_label='drafts'),
                             login_url=reverse_lazy('login'))
...
urlpatterns = patterns('',
    ...
    url(r'^tasks/draft$', tasks_draft, name='tasks_draft'),
