...
PERMISSIONS_TABLE = {
  ...
  EDITOR_GROUP+str(PROCESSING)+CAN_MESSAGE+IS_LOCKED: 1,
  WRITER_GROUP+str(PROCESSING)+CAN_MESSAGE+IS_LOCKED: 1,
  ...
  EDITOR_GROUP+str(SUSPICIOUS)+CAN_MESSAGE+IS_LOCKED: 1,
  WRITER_GROUP+str(SUSPICIOUS)+CAN_MESSAGE+IS_LOCKED: 1,
  ...
  EDITOR_GROUP+str(REJECTED)+CAN_MESSAGE+IS_LOCKED: 1,
  WRITER_GROUP+str(REJECTED)+CAN_MESSAGE+IS_LOCKED: 1,
  ...
  EDITOR_GROUP+str(COMPLETED)+CAN_MESSAGE+IS_LOCKED: 1,
  WRITER_GROUP+str(COMPLETED)+CAN_MESSAGE+IS_LOCKED: 1,
  ...
  EDITOR_GROUP+str(SENT)+CAN_MESSAGE+IS_LOCKED: 1,
  WRITER_GROUP+str(SENT)+CAN_MESSAGE+IS_LOCKED: 1,
  },
  'upload': {
  # Draft permissions.
  ...
  EDITOR_GROUP+str(UNPROCESSED)+CAN_UPLOAD+IS_LOCKED: 1,
  ADMIN_GROUP+str(UNPROCESSED)+CAN_DELETE: 1,
  ADMIN_GROUP+str(UNPROCESSED)+CAN_CH_VISIBILITY: 1,
  EDITOR_GROUP+str(UNPROCESSED)+CAN_CH_VISIBILITY+IS_LOCKED: 1,
  EDITOR_GROUP+str(UNPROCESSED)+CAN_DELETE+IS_LOCKED: 1,

  # Active or in progress permissions.
  CUSTOMER_GROUP+str(PROCESSING)+CAN_UPLOAD: 1,
  ADMIN_GROUP+str(PROCESSING)+CAN_UPLOAD: 1,
  EDITOR_GROUP+str(PROCESSING)+CAN_UPLOAD+IS_LOCKED: 1,
  WRITER_GROUP+str(PROCESSING)+CAN_UPLOAD+IS_LOCKED: 1,
  ADMIN_GROUP+str(PROCESSING)+CAN_CH_VISIBILITY: 1,
  ADMIN_GROUP+str(PROCESSING)+CAN_DELETE: 1,
  EDITOR_GROUP+str(PROCESSING)+CAN_DELETE+IS_LOCKED: 1,
  EDITOR_GROUP+str(PROCESSING)+CAN_CH_VISIBILITY+IS_LOCKED: 1,

  # Suspicious permissions.
  CUSTOMER_GROUP+str(SUSPICIOUS)+CAN_UPLOAD: 1,
  ADMIN_GROUP+str(SUSPICIOUS)+CAN_UPLOAD: 1,
  EDITOR_GROUP+str(SUSPICIOUS)+CAN_UPLOAD+IS_LOCKED: 1,
  ADMIN_GROUP+str(SUSPICIOUS)+CAN_CH_VISIBILITY: 1,
  ADMIN_GROUP+str(SUSPICIOUS)+CAN_DELETE: 1,
  EDITOR_GROUP+str(SUSPICIOUS)+CAN_CH_VISIBILITY+IS_LOCKED: 1,
  EDITOR_GROUP+str(SUSPICIOUS)+CAN_DELETE+IS_LOCKED: 1,

  # Rejected 
  EDITOR_GROUP+str(REJECTED)+CAN_CH_VISIBILITY+IS_LOCKED: 1,
  ...
  ADMIN_GROUP+str(COMPLETED)+CAN_DELETE: 1,
  EDITOR_GROUP+str(COMPLETED)+CAN_CH_VISIBILITY+IS_LOCKED: 1,
  EDITOR_GROUP+str(COMPLETED)+CAN_DELETE+IS_LOCKED: 1,
  WRITER_GROUP+str(COMPLETED)+CAN_UPLOAD+IS_LOCKED: 1,
  EDITOR_GROUP+str(COMPLETED)+CAN_UPLOAD+IS_LOCKED: 1,
  ADMIN_GROUP+str(COMPLETED)+CAN_UPLOAD: 1,

  # Send
  CUSTOMER_GROUP+str(SENT)+CAN_UPLOAD: 1,
  ADMIN_GROUP+str(SENT)+CAN_UPLOAD: 1,
  WRITER_GROUP+str(SENT)+CAN_UPLOAD+IS_LOCKED: 1,
  EDITOR_GROUP+str(SENT)+CAN_UPLOAD+IS_LOCKED: 1,
  ADMIN_GROUP+str(SENT)+CAN_CH_VISIBILITY: 1,
  ADMIN_GROUP+str(SENT)+CAN_DELETE: 1,
  EDITOR_GROUP+str(SENT)+CAN_CH_VISIBILITY+IS_LOCKED: 1,
  EDITOR_GROUP+str(SENT)+CAN_DELETE+IS_LOCKED: 1,
  },
  ...
  WRITER_GROUP+str(PROCESSING)+CAN_SEND+IS_LOCKED: 1,
  EDITOR_GROUP+str(PROCESSING)+CAN_LOCK: 1,
  EDITOR_GROUP+str(PROCESSING)+CAN_REPORT+IS_LOCKED: 1,
  EDITOR_GROUP+str(PROCESSING)+CAN_UNLOCK+IS_LOCKED: 1,
  ...
  EDITOR_GROUP+str(SUSPICIOUS)+CAN_REPORT+IS_LOCKED: 1,
  EDITOR_GROUP+str(SUSPICIOUS)+CAN_UNLOCK+IS_LOCKED: 1,
  ...
  EDITOR_GROUP+str(REJECTED)+CAN_REPORT+IS_LOCKED: 1,
  EDITOR_GROUP+str(REJECTED)+CAN_LOCK: 1,
  EDITOR_GROUP+str(REJECTED)+CAN_UNLOCK+IS_LOCKED: 1,
  ...
  EDITOR_GROUP+str(COMPLETED)+CAN_REPORT+IS_LOCKED: 1,
  EDITOR_GROUP+str(COMPLETED)+CAN_LOCK: 1,
  EDITOR_GROUP+str(COMPLETED)+CAN_UNLOCK+IS_LOCKED: 1,

  # Send
  ADMIN_GROUP+str(SENT)+CAN_LOCK: 1,
  ADMIN_GROUP+str(SENT)+CAN_UNLOCK: 1,
  EDITOR_GROUP+str(SENT)+CAN_LOCK: 1,
  EDITOR_GROUP+str(SENT)+CAN_UNLOCK+IS_LOCKED: 1,
  EDITOR_GROUP+str(SENT)+CAN_COMPLETE+IS_LOCKED: 1,
  EDITOR_GROUP+str(SENT)+CAN_REPORT+IS_LOCKED: 1,
